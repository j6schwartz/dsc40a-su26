...
- Please fill out the [Welcome Survey](https://forms.gle/qA5xnzXiNZc55nii6) if you haven't already.
- Homework 1 is release, and is due on **Friday, August 9th**.
  - We will soon release an [Overleaf](https://www.overleaf.com/learn/how-to/How_do_I_use_Overleaf%3F) template, where you can _type_ your solutions using $\LaTeX$.

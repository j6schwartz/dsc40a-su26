...
- Homework 1 is due on **Friday, August 9th**.
  ...
  - The [Overleaf template](https://www.overleaf.com/read/nhhqyfgqzvjm#4c8804) has been released.
  - Using the Overleaf template is required for (only) Homework 2.
- Discussion is today, directly after lecture at 2p here.
  - Remember that, in general, groupwork worksheets are released on Tuesday and due Wednesday.
